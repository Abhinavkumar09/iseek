console.log("loaded prescription element");

Q.scene("show_prescription",function(stage) {
	stage.name = "show_prescription";

	stage.desc_card = new Q.StageInfoCard({
		description: new Q.ImageText({
			label: new Q.UI.WrappableText({label: "Hi! Scene to display prescriptions"}),
		}),
		context: stage,
	});
...
var card = new Q.showPrescription({ });
